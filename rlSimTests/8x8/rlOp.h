...
#define ENV_ULIMIT_X	7	// 0-7, so ENV_SIZE_X = 8
#define ENV_ULIMIT_Y	7	// 0-7, so ENV_SIZE_Y = 8
#define ENV_LLIMIT	0
#define ENV_SIZE_X	8
#define ENV_SIZE_Y	8
 ...
 * If the agent walks into an obstacles, a reward of -100 is given
 */
#define OBSTACLE	-100
